...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'myBanana', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_143b3b31bd013aaabda69b62f78bff93963beab0b54a9d9fd397c9ce36936d8d');
        return $instance;
    }
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=localhost;port=3306;dbname=myBanana', 'root', '');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    '/var/www/html/myBanana/app/../web/customize' => 'customize',
                    '/var/www/html/myBanana/app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    '/var/www/html/myBanana/app/../web/themes' => 'theme',
                    '/var/www/html/myBanana/app/../' => 'root',
                ),
