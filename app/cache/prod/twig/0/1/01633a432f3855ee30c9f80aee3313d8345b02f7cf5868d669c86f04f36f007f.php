...
class __TwigTemplate_01633a432f3855ee30c9f80aee3313d8345b02f7cf5868d669c86f04f36f007f extends Twig_Template
{
...
\t\t\t\t";
                ...
                if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "question", array()), "testResult", array()), "status", array()) == "right")) {
                    ...
                    echo "</strong>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("，回答正确"), "html", null, true);
                    echo "
\t\t\t\t";
...
(isset($context["item"]) ? $context["item"] : null), "question", array()), "testResult", array()), "status", array()) == "partRight")) {
                    ...
                    echo twig_escape_filter($this->env, twig_join_filter((isset($context["keys"]) ? $context["keys"] : null), ","), "html", null, true);
                    echo "</strong>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("，你的答案是"), "html", null, true);
                    ...
                    echo "</strong>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("。回答部分正确。得分："), "html", null, true);
...
(isset($context["item"]) ? $context["item"] : null), "question", array()), "testResult", array()), "status", array()) == "wrong")) {
                    ...
                    echo twig_escape_filter($this->env, twig_join_filter((isset($context["keys_answer"]) ? $context["keys_answer"] : null), ","), "html", null, true);
                    echo "</strong>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("。回答错误"), "html", null, true);
                    echo "
\t\t\t\t";
...
(isset($context["item"]) ? $context["item"] : null), "question", array()), "testResult", array()), "status", array()) == "noAnswer")) {
                    ...
                    echo twig_escape_filter($this->env, twig_join_filter((isset($context["keys"]) ? $context["keys"] : null), ","), "html", null, true);
                    echo "</strong>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("，你未答题"), "html", null, true);
                    echo "
\t\t\t\t";
                }
                // line 39
...
";
    ...
    {
        return array (  267 => 77,  262 => 74,  257 => 72,  248 => 68,  244 => 66,  242 => 65,  237 => 62,  235 => 61,  231 => 59,  222 => 56,  206 => 55,  194 => 54,  191 => 53,  188 => 52,  184 => 51,  179 => 48,  174 => 46,  169 => 43,  167 => 42,  162 => 39,  152 => 37,  150 => 36,  137 => 35,  135 => 34,  120 => 33,  118 => 32,  109 => 31,  107 => 30,  103 => 28,  101 => 27,  97 => 25,  91 => 24,  88 => 23,  85 => 22,  82 => 21,  79 => 20,  76 => 19,  74 => 18,  66 => 17,  63 => 16,  60 => 15,  57 => 14,  53 => 13,  49 => 11,  47 => 10,  44 => 9,  41 => 8,  39 => 7,  28 => 5,  24 => 3,  22 => 2,  19 => 1,);
    }
}
